...
public class DaftarBarangStatusProses extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public class Recycle_adapterStatusTunda extends RecyclerView.Adapter<Recycle_adapterStatusTunda.My_viewHolder> {
        ...
        public class My_viewHolder extends RecyclerView.ViewHolder {
            ...
            Button btn_tolak,btn_selesaikan,btn_proses;
        ...
        public void onBindViewHolder(@NonNull final Recycle_adapterStatusTunda.My_viewHolder holder, final int position) {
            ...
            if (parse == 1) {
                ...
                holder.btn_selesaikan.setVisibility(View.VISIBLE);
                holder.layout_yellow.setVisibility(View.VISIBLE);
                holder.layout_red.setVisibility(View.GONE);
            }
            holder.btn_selesaikan.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    push_notifikasi(categories.getProductsArrayList().get(position).getNama_barang()+" pesanan anda terselesaikan",categories.getProductsArrayList().get(position).getToken());
